...
International Symposium on Research in Attacks, Intrusions and Defenses, 2026. [<span style="color: black;">(</span>PDF<span style="color: black;">)</span>](../_publications/LLMalware_RAID2026.pdf)</span>
...
IEEE Wireless Communications and Networking Conference, 2020. [<span style="color: black;">(</span>PDF<span style="color: black;">)</span>](../_publications/Exact algorithms for barrier coverage with line-based deployed rotatable directional sensors.pdf)
...
IEEE Transactions on Mobile Computing, 2022. [<span style="color: black;">(</span>PDF<span style="color: black;">)</span>](../_publications/RF-Siamese.pdf)
...
IEEE Transactions on Mobile Computing, 2022. [<span style="color: black;">(</span>PDF<span style="color: black;">)</span>](../_publications/Real-time_and_Accurate_Gesture_Recognition_with_Commercial_RFID_Devices.pdf)
...
IEEE Transactions on Mobile Computing, 2022. [<span style="color: black;">(</span>PDF<span style="color: black;">)</span>](../_publications/HearMe_Accurate_and_Real-time_Lip_Reading_based_on_Commercial_RFID_Devices.pdf)
...
Computer Science and Information Systems, 2020. [<span style="color: black;">(</span>PDF<span style="color: black;">)</span>](../_publications/Energy-efficient non-linear k-barrier coverage in mobile sensor network.pdf)
